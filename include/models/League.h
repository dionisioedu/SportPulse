...
struct League {
    std::string idLeague;
    std::string idSoccerXML;
    std::string idAPIfootball;
    std::string strSport;
    std::string strLeague;
    std::string strLeagueAlternate;
    std::string intDivision;
    std::string idCup;
    std::string strCurrentSeason;
    std::string intFormedYear;
    std::string dateFirstEvent;
    ...
    std::string strTrophy;
    std::string strNaming;
